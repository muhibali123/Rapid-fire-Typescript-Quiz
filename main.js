...
console.log(chalk.yellowBright("─────────────────────────────────────────────────────────────────────────────────"));
console.log(chalk.blueBright("✨🌸✨ In this Timer quiz application you will have only ten seconds to give answer otherwise the answer will did not count ✨🌸✨"));
...
const questions = [
    {
        question: "Which of the following TypeScript features allows you to ensure that a certain property is always present in an object at compile time?",
        choices: [
            "Optional Chaining",
            "Mapped Types",
            "Utility Types",
    ...
    {
        question: "In TypeScript, which utility type would you use to create a type by picking a set of properties from another type?",
    ...
    {
        question: "Which TypeScript feature allows you to define the shape of a data structure and enforce it at compile time?",
        choices: ["Interfaces", "Generics", "Type Aliases", "All of the above"],
        correctAnswer: "All of the above",
    },
    {
        question: "Which of the following best describes the purpose of TypeScript's never type?",
        choices: [
    ...
    {
        question: "Which of the following constructs is used to create a type that extracts the return type of a function in TypeScript?",
        choices: ["Extract<T, U>", "ReturnType<T>", "Return<T>", "TypeOfReturn<T>"],
        correctAnswer: "ReturnType<T>",
    },
    {
        question: "How can you make a property in an interface read-only in TypeScript?",
        choices: [
    ...
    {
        question: "How can you define a function that accepts a variable number of arguments in TypeScript?",
        choices: [
...
if (sure_play.play) {
    async function askQuestionWithTimer(question) {
        return new Promise((resolve) => {
            ...
            inquirer
                ...
                if (answer.userAnswer) {
                    ...
                    resolve(answer.userAnswer.toLowerCase() ===
    ...
    async function mainWithTimer() {
        ...
        if (score === questions.length) {
            ...
            console.log(chalk.cyanBright(`\n═══════════════════════════════════════════════════════════════════════════════ \n`));
            console.log(chalk.redBright(`${username.name} Your final score is: ${score}0 / 100 \n`));
            console.log(chalk.cyanBright(`\n═══════════════════════════════════════════════════════════════════════════════`));
        }
    }
    mainWithTimer();
    ...
    console.log(chalk.redBright("Thank you for running this Quiz application Thanks! "));
}
